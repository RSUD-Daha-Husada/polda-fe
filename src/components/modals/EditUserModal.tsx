            ...
            <div className="bg-white w-full max-w-4xl rounded-lg shadow p-6 space-y-4">
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">Ubah Foto</label>
                            ...
                            <div className="flex justify-center items-center h-32 w-32 border rounded mb-4 bg-gray-100">
                                {photoPreview ? (
                                    <img
                                        src={
                                            photoPreview
                                                ? photoPreview.includes("http") || photoPreview.includes("localhost") || photoPreview.includes("data:image/")
                                                    ? photoPreview
                                                    : `${AVATAR_BASE_URL}/${photoPreview}`
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                type="text"
                                className="w-full p-2 border rounded text-sm placeholder:text-sm placeholder:text-gray-400"
